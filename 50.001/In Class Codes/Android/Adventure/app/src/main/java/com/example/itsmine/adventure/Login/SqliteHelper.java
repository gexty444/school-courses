...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    //DATABASE NAME
    public static final String DATABASE_NAME = "Adventure";
...
//        SQLiteDatabase db = this.getWritableDatabase();
        ...
        // insert row
        long todo_id = writeableDb.insert(TABLE_USERS, null, values);
    }
...
//        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = readableDb.query(TABLE_USERS,// Selecting Table
