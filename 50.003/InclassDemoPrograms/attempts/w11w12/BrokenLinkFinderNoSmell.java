...
public class BrokenLinkFinderNoSmell {
    ...
    public static String connectAndRespond(HttpURLConnection linkConnection) throws IOException {
	...
	public static void brokenLinkChecker(URL hyperLink) throws Exception {
		...
		try {
			...
			acknowledge = connectAndRespond(linkConnection);        // avoid repeating
	...
	public static boolean printIfRedirected(URL hyperLink) throws Exception {
		String acknowledge = null;
		HttpURLConnection linkConnection = (HttpURLConnection) hyperLink.openConnection();
