...
public class ShootTheAccount {
    ...
    // Added a boolean attribute called businessAccount.
    // Edited the if conditions for DebitTransaction, Transfer and sendWarning methods
  ...
  public ShootTheAccount (boolean businessAccount) {
  ...
  public void DebitTransaction(int amount) {
	  ...
	  if (balance >= 500 || businessAccount ) {
		  //reduce the amount
		  balance = balance - amount;
