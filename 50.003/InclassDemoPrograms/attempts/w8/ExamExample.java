...
public class ExamExample {
    private final static int numberOfStudents = 5;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i=0; i<numberOfStudents; i++){
            students[i] = new Student(phaser, i+1);         // register students to phaser first before running
        }
        examiner.start();
...
class Examiner extends Thread{
    ...
    public void run() {
        System.out.println("Examiner is waiting patiently for " + numberOfStudents + " students to get ready");
